...
const T = {
  es: {
    ...
    dlNote: 'Requiere Bluetooth LE · macOS 12+, Windows 10+, Linux · En macOS: clic derecho → Abrir la primera vez',
  ...
  en: {
    ...
    dlNote: 'Requires Bluetooth LE · macOS 12+, Windows 10+, Linux · On macOS: right-click → Open the first time',
