    ...
    <header className="fixed top-0 inset-x-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <a href="https://icy-hill-066964603.2.azurestaticapps.net/login" className="px-4 py-2 text-sm font-semibold text-slate-600 hover:text-slate-900 transition-colors">
            Log In
          </a>
      ...
      {open && (
        <div className="md:hidden border-t border-slate-100 bg-white px-6 py-4 flex flex-col gap-4 text-sm font-medium text-slate-700">
          ...
          <a href="https://icy-hill-066964603.2.azurestaticapps.net/login" className="text-slate-500">Log In</a>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <nav className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <a href="https://icy-hill-066964603.2.azurestaticapps.net/login" className="hover:text-white transition-colors">Log In</a>
          </nav>
