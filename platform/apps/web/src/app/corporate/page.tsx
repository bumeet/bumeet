...
const T = {
  en: {
    ...
    footer: {
      ...
      macNote: 'macOS: if Gatekeeper blocks the installer, right-click → Open',
  ...
  es: {
    ...
    footer: {
      ...
      macNote: 'macOS: si Gatekeeper bloquea el instalador, clic derecho → Abrir',
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <a href={`${RELEASES}/bumeet-agent.dmg`} className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl border-2 border-slate-200 text-slate-700 font-bold text-sm hover:border-sky-300 hover:bg-sky-50 transition-all">
              {t.cta2}
            </a>
          </div>
...
const DOWNLOAD_ITEMS = [
  {
    os: 'macOS', sub: 'Apple Silicon & Intel · macOS 13+',
